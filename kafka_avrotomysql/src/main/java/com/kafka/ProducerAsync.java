...
public class ProducerAsync {
    public static void main(String[] args) {
        ...
        props.put("bootstrap.servers", "127.0.0.1:9092"); //브로커 리스트를 정의합니다.
        ...
        try {
            for (int i = 0; i < 3; i++) {
                ProducerRecord<String, String> record = new ProducerRecord<>("testTopic", "Apache Kafka is a distributed streaming platform - " + i); //ProducerRecord 오브젝트를 생성합니다.
